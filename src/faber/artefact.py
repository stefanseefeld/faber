...
from .delayed import DelayedProperty
from .utils import PathFormatter, add_metaclass
from . import logging
...
class Artefact(object):
    ...
    def __init__(self, name, attrs=0, type=None, module=None,
        ...
        self.module = module or Module.current
        self.attrs = attrs
...
class SourceType(type):
    def __call__(cls, name, *args, **kwds):
        ...
        from .module import Module
        module = kwds.get('module') or Module.current
