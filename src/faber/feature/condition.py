...
class expr(object):
    ...
    def __eq__(self, other): return bin(operator.eq, self, other)
    def __neq__(self, other): return bin(operator.neq, self, other)
    def __gt__(self, other): return bin(operator.gt, self, other)
    def __lt__(self, other): return bin(operator.lt, self, other)
    def __and__(self, other): return bin(operator.and_, self, other)
    def __or__(self, other): return bin(operator.or_, self, other)
    def __bool__(self): raise ValueError('invalid expression !')
