...
from PyQt6.QtWidgets import QMenu, QMainWindow, QComboBox, QPushButton, QMessageBox
...
class Main(QMainWindow):
    ...
    def __init__(self, module, config):
        ...
        self.ui.logo.setAttribute(Qt.WidgetAttribute.WA_TranslucentBackground, True)
        self.ui.sourcedir_label.setAttribute(Qt.WidgetAttribute.WA_TranslucentBackground, True)
        self.ui.builddir_label.setAttribute(Qt.WidgetAttribute.WA_TranslucentBackground, True)
        self.ui.sourcedir.setAttribute(Qt.WidgetAttribute.WA_TranslucentBackground, True)
        self.ui.builddir.setAttribute(Qt.WidgetAttribute.WA_TranslucentBackground, True)
        ...
        self.ui.log.model().item(0, 0).setFlags(Qt.ItemFlag.NoItemFlags)
    ...
    def tree_menu(self, position):
        ...
        if not selected:
            return
        index = selected[0]
        menu = self.make_context_menu(index.data(Qt.ItemDataRole.UserRole), deps=True)
        menu.exec(self.ui.tree.viewport().mapToGlobal(position))
