# Form implementation generated from reading ui file 'bench/faber_bench/main.ui'
#
...
class Ui_main(object):
    def setupUi(self, main):
        ...
        self.sourcedir = QtWidgets.QLabel(parent=self.widget)
        ...
        self.sourcedir_label = QtWidgets.QLabel(parent=self.widget)
        ...
        self.builddir_label = QtWidgets.QLabel(parent=self.widget)
        ...
        self.logo.setTextFormat(QtCore.Qt.TextFormat.RichText)
        self.logo.setScaledContents(True)
        self.logo.setObjectName("logo")
        self.gridLayout.addWidget(self.logo, 0, 0, 1, 1)
        self.builddir = QtWidgets.QLabel(parent=self.widget)
        ...
        self.tree = QtWidgets.QTreeView(parent=self.splitter)
        self.tree.setBaseSize(QtCore.QSize(0, 250))
        self.tree.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        ...
        self.output = QtWidgets.QTextEdit(parent=self.splitter)
        self.output.setBaseSize(QtCore.QSize(0, 250))
        self.output.setStyleSheet("")
        self.output.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOn)
        self.output.setLineWrapMode(QtWidgets.QTextEdit.LineWrapMode.NoWrap)
        self.output.setReadOnly(True)
        self.output.setObjectName("output")
        self.verticalLayout.addWidget(self.splitter)
        self.progress = ProgressBar(parent=self.centralwidget)
        ...
        self.quit = QtGui.QAction(parent=main)
        self.quit.setObjectName("quit")
        self.scheduler = QtGui.QAction(parent=main)
        self.scheduler.setObjectName("scheduler")
        self.about = QtGui.QAction(parent=main)
        self.about.setObjectName("about")
        self.view_public_artefacts = QtGui.QAction(parent=main)
        self.view_public_artefacts.setObjectName("view_public_artefacts")
        self.view_all_artefacts = QtGui.QAction(parent=main)
